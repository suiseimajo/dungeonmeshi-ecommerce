            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" wire:submit="store" class="mt-6 space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            <x-input-label for="imagens" value="Imagens" />
                            ...
                            <div class="flex flex-row">
                                ...
                                <li class="block p-1 w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-1/8 h-32">
                                    <article tabindex="0" class="group hasImage w-full h-full rounded-md focus:outline-none focus:shadow-outline bg-gray-100 cursor-pointer relative text-transparent hover:text-white shadow-sm">
                                        <img alt="upload preview" src="{{ $img->temporaryUrl() }}" class="img-preview w-full h-full sticky object-cover rounded-md bg-fixed" />

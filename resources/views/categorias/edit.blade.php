        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ isset($category) ? route('categorias.update', $category->id) : route('categorias.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <label class="block mt-2">
                                ...
                                <input type="file" id="imagem" name="imagem" class="block w-full text-sm text-slate-500

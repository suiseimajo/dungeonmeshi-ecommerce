    ...
    <div class="container pb-16">
        ...
        <div class="grid grid-cols-4 gap-6">
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                <a href="#"
                    class="block w-full py-1 text-center text-white bg-primary border border-primary rounded-b hover:bg-transparent hover:text-primary transition">Adicionar a oCarrinho</a>
            </div>
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
